...
export { isElement, isEmpty, isPropAbsent, isUndefined } from './types.mjs';
...
export { PatchFlags, ensureOnlyChild, getFirstValidNode, getNormalizedProps, isComment, isFragment, isTemplate, isText, isValidElementNode, renderBlock, renderIf } from './vue/vnode.mjs';
