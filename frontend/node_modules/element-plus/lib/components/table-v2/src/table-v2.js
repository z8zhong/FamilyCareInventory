  ...
  setup(props, {
    ...
    return () => {
      ...
      const tableCellProps = {
        ...
        iconSize,
        rowKey,
        columnsStyles: vue.unref(columnsStyles),
        expandedRowKeys: vue.unref(expandedRowKeys),
        ns
      };
      ...
      const tableSlots = {
        row: (props2) => vue.createVNode(row["default"], vue.mergeProps(props2, tableRowProps), {
          ...
          cell: (props3) => slots.cell ? vue.createVNode(cell["default"], vue.mergeProps(props3, tableCellProps), {
            default: () => [slots.cell]
          }) : vue.createVNode(cell["default"], vue.mergeProps(props3, tableCellProps), null)
        }),
        header: (props2) => vue.createVNode(header["default"], vue.mergeProps(props2, tableHeaderProps), {
          ...
          }) : vue.createVNode(headerCell["default"], vue.mergeProps(props3, tableHeaderCellProps), null)
        })
      };
